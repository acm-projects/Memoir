...
// ✅ FIX: define the scroll content height as a constant so it's used consistently
// in both the ScrollView layout and the boardSize state passed to DraggableItem
...
      // ✅ FIX: keep type as "gif" so DraggableItem's explicit gif branch renders it
...
              // ✅ FIX: only capture the frame width here; height is always BOARD_CONTENT_HEIGHT
              onLayout={(e) =>
...
                    boardHeight={boardSize.height} // always 1500
                  />
                ))}
              </ScrollView>
            </View>
